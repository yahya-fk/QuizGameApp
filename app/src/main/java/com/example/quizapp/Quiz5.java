...
public class Quiz5 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        DatabaseReference userReference = FirebaseDatabase.getInstance().getReference().child(type).child("Quiz5");
    ...
    protected void onStart() {
        ...
        if (currentUser == null) {
            Intent intent = new Intent(Quiz5.this, MainActivity.class);
            startActivity(intent);
        }
        else {
