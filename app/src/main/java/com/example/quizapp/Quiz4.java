...
public class Quiz4 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        DatabaseReference userReference = FirebaseDatabase.getInstance().getReference().child(type).child("Quiz4");
    ...
    protected void onStart() {
        ...
        if (currentUser == null) {
            Intent intent = new Intent(Quiz4.this, MainActivity.class);
            startActivity(intent);
        }
        else {
